        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-28 items-center">
          <RevealWrap direction="left">
            ...
            <h2 className="font-heading text-platinum leading-[0.95] tracking-[-0.01em] text-[clamp(36px,4.5vw,60px)] mb-6">
              ...
              <span className="italic text-brand-gradient">Growing Businesses</span>
            </h2>
          ...
          <RevealWrap direction="right" delay={0.15}>
            <div className="grid grid-cols-2 gap-4">
              {PILLARS.map((p, i) => (
                <div key={i} className="glass rounded-2xl p-6 group hover:border-electric/30 transition-all duration-300 hover:-translate-y-1 cursor-default">
                  <div className="w-8 h-[1px] bg-electric mb-4 group-hover:w-14 transition-all duration-300" />
