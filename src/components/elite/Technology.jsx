      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        <RevealWrap className="text-center mb-16">
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <span className="text-[11px] font-semibold tracking-[0.18em] uppercase text-electric-light">Integrations</span>
            <div className="w-6 h-[0.5px] bg-electric" />
          </div>
          <h2 className="font-heading text-platinum text-[clamp(32px,4vw,52px)] leading-tight">
            Built on Tools You <span className="italic text-brand-gradient">Already Trust</span>
          </h2>
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {TECHS.map((tech, i) => (
            <RevealWrap key={tech} delay={i * 0.04}>
              <div className="glass rounded-full px-6 py-3 group hover:border-electric/25 hover:-translate-y-0.5 transition-all duration-300 cursor-default">
